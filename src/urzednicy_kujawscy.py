""" spis urzędników kujawskich i dobrzyńskich XVI-XVIII wieku """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_kujawscy_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy kujawscy i dobrzyńscy XVI-XVIII wieku, w: Urzędnicy dawnej Rzeczypospolitej XII - XVIII wieku, t. VI, z. 2, 1990'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_kujawscy_i_dobrzynscy_XVI_XVIII_wieku.txt'
    output_path = Path('.').parent / 'output/urzednicy_kujawscy_i_dobrzynscy_XVI_XVIII_wieku.xml'
