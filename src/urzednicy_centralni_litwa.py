""" spis urzędników centralnych litewskich  XIV-XVIII wiek """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_centralni_litwa_literatura import literatura
...
skroty_geo = {
    ...
    "WKskRuskie":"Wielkie Księstwo Ruskie",
    "włod.":"włodzimierski",
    "woł.":"wołyński",
    "wołk.":"wołkowyski",
    "żm.":"żmudzki",
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy centralni i dygnitarze Wielkiego Księstwa Litewskiego XIV-XVIII wieku, [w:] Urzędnicy dawnej Rzeczypospolitej XII-XVIII wieku, t. XI, Kórnik 1994'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_centralni_litwa_xiv_xviii.txt'
    output_path = Path('.').parent / 'output/urzednicy_centralni_litwa_xiv_xviii.xml'
