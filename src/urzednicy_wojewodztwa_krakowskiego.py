""" spis urzędników województwa krakowskiego XVI-XVIII wieku """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_wojewodztwa_krakowskiego_literatura import literatura
...
skroty_urz = {
    ...
    "cz.":"cześnik",
    "klan":"kasztelan",
    "kom. graniczny":"komornik graniczny",
    "kom. gran.":"komornik graniczny",
    "kom. ziem.":"komornik ziemski",
    "kpt.":"kapitan",
    "łow.":"łowczy",
    "miecz.":"miecznik",
    "mjr":"major",
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy województwa krakowskiego XVI-XVIII wieku, w: Urzędnicy dawnej Rzeczypospolitej XII - XVIII wieku, t. IV, z. 2, 1990'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_wojewodztwa_krakowskiego_XVI-XVIII_wieku.txt'
    output_path = Path('.').parent / 'output/urzednicy_wojewodztwa_krakowskiego_XVI-XVIII_wieku.xml'
