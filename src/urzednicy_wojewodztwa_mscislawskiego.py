""" spis urzędników wojewodztwa mścisławskiego XVI-XVIII wiek """
import re
...
skroty_geo = {
    ...
    "płot.":"płotelski",
    "poj.":"pojurski",
    "połon.":"połongowski (połągowski)",
    "potum.":"potumszewski",
    "powon.":"powondeński",
    "Radom.":"radomlski (radomelski)",
    "ret.":"retowski",
    "skir.":"skirstymoński (skierstymoński)",
    "szawd.":"szawdowski",
    "tend.":"tendziagolski",
    "tw.":"twerski",
    "użw.":"użwencki",
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy Wielkiego Księstwa Litewskiego. Spisy,  T. IX Województwo Mścisławskie XVI–XVIII wiek, Warszawa 2019'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_wojewodztwa_mscislawskiego.txt'
    output_path = Path('.').parent / 'output/urzednicy_wojewodztwa_mscislawskiego.xml'
