...
from urzednicy_centralni_polska_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy centralni i nadworni Polski XIV-XVIII wieku, [w:] Urzędnicy dawnej Rzeczypospolitej XII-XVIII wieku, t. X, Kórnik 1992'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_centralni_polska_xiv_xviii.txt'
    output_path = Path('.').parent / 'output/urzednicy_centralni_polska_xiv_xviii.xml'
