""" spis urzędników ziemii połockiej XIV-XVIII wiek """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_ziemia_polocka_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy Wielkiego Księstwa Litewskiego. Spisy,  T. VIII, Ziemia Połocka i Województwo Połockie XIV–XVIII wiek, Warszawa 2018'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_ziemia_polocka.txt'
    output_path = Path('.').parent / 'output/urzednicy_ziemia_polocka_xiv_xviii_wiek.xml'
