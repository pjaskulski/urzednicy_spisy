""" spis urzędników lubelskich XVI-XVIII wiek """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_lubelscy_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy województwa lubelskiego XVI - XVIII wieku, w: Urzędnicy dawnej Rzeczypospolitej XII-XVIII wieku, t. 4, z. 4, Kórnik 1991'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_wojewodztwa_lubelskiego_XVI_XVIII_wieku.txt'
    output_path = Path('.').parent / 'output/urzednicy_wojewodztwa_lubelskiego_XVI_XVIII_wieku.xml'
