""" spis urzędników podolskich XIV-XVIII wiek """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_podolscy_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy podolscy XIV - XVIII wieku, w: Urzędnicy dawnej Rzeczypospolitej XII - XVIII wieku, t. III, z. 3, 1998'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_podolscy_XIV_XVIII_wieku.txt'
    output_path = Path('.').parent / 'output/urzednicy_podolscy_XIV_XVIII_wieku.xml'
