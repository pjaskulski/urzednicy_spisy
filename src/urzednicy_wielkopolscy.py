...
from urzednicy_wielkopolscy_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy wielkopolscy XII-XIV wieku, w: Urzędnicy dawnej Rzeczypospolitej XII - XVIII wieku, t. I, z. 1, 1985'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_wielkopolscy_XII_XIV_wiek.txt'
    output_path = Path('.').parent / 'output/urzednicy_wielkopolscy_XII_XIV_wiek.xml'
