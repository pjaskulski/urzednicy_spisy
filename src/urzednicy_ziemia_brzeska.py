""" spis urzędników ziemii brzeskiej XIV-XVIII wiek """
import re
...
skroty_urz = {
    ...
    "psęd.":"podsędek",
    "pskar.":"podskarbi",
    "psta-nam.":"podstarości (namiestnik)",
    "psta.":"podstarości",
    "pstoli":"podstoli",
    "pwoj.":"podwojewodzi",
    "ref.":"referendarz",
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy Wielkiego Księstwa Litewskiego. Spisy,  T. VIII, Ziemia Brzeska i Województwo Brzeskie XIV–XVIII wiek, Warszawa 2020'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_ziemia_brzeska.txt'
    output_path = Path('.').parent / 'output/urzednicy_ziemia_brzeska_xiv_xviii_wiek.xml'
