""" spis urzędników wielkopolskich XVI-XVIII wieku """
import re
from pathlib import Path
import xml.dom.minidom
from urzednicy_wielkopolscy_xvi_literatura import literatura
...
class Position:
    def __init__(self, office:str='') -> None:
        self.office = office
        self.stated_in = 'Urzędnicy wielkopolscy XVI-XVIII wieku, w: Urzędnicy dawnej Rzeczypospolitej XII - XVIII wieku, t. I, z. 2, 1987'
        self.id = ''
        self.reference_id = ''
        self.start_date = ''
        self.end_date = ''
...
if __name__ == '__main__':
    input_path = Path('.').parent / 'data/urzednicy_wielkopolscy_XVI_XVIII_wieku.txt'
    output_path = Path('.').parent / 'output/urzednicy_wielkopolscy_XVI_XVIII_wieku.xml'
